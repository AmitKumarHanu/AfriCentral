...
public class CommonFunctions
{
    ...
    public static string conBranch = System.Configuration.ConfigurationManager.ConnectionStrings["conBranch"].ToString();
    ...
    public static DataTable fetchdataBranch(string query)
    {
        SqlConnection con = new SqlConnection(conBranch);
        con.Open();
        SqlDataAdapter da = new SqlDataAdapter(query, con);
        DataTable dt = new DataTable();
        da.Fill(dt);
