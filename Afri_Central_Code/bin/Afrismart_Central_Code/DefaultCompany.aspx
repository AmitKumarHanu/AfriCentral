<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="DefaultCompany.aspx.cs" Inherits="DefaultCompany" %>
    ...
    <div class="emov-page-main">
       ...
       <div class="emov-dash-stats-wrapper">
         ...
         <div class="emov-dash-stats-charts-wrapper" style="border-radius:20%;">
          ...
          <div class="donut-bg">
               <div id="PieChartAmountSales" style="width: 100%; height: 400px">  </div>
          </div>
            <div class="donut-bg">
               <div id="PieChartSales" style="width: 100%; height: 400px"> </div>         
            </div>
           ...
           <!-- 2nd Chart-->
         <div class="emov-dash-stats-charts-wrapper" style="border-radius:20%; display:none;" >
