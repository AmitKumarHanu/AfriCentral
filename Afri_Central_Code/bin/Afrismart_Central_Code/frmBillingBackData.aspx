<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="frmBillingBackData.aspx.cs" Inherits="frmBillingBackData" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <script type="text/javascript">
                $(document).ready(function () {
                    ...
                    today = $('#<%= txt_date.ClientID %>').val()

                    $('#<%= txtBillDate.ClientID %>').val(today)

                    $("#<%=hdnBillingDate.ClientID %>").val(today);
        ...
        $(function () {
            ...
            $('#<%=txtBarCodeNo.ClientID%>').autocomplete({
                source: function (request, response) {
                    $.ajax({
                        url: "frmBillingBackData.aspx/GetBarcode",
     ...
     <script language="javascript" type="text/javascript">
         $(function () {
             ...
             $('#<%=txtItemName.ClientID%>').autocomplete({
                source: function (request, response) {
                    $.ajax({
                        url: "frmBillingBackData.aspx/GetitemName",
     ...
     <script language="javascript" type="text/javascript">
         $(function () {
             ...
             $('#<%=txtReferetBy.ClientID%>').autocomplete({
                 source: function (request, response) {
                     $.ajax({
                         url: "frmBillingBackData.aspx/GetReferedBy",
     ...
     <script language="javascript" type="text/javascript">
         $(function () {
             ...
             $('#<%=txtCusMobileNo.ClientID%>').autocomplete({
                 source: function (request, response) {
                     $.ajax({
                         url: "frmBillingBackData.aspx/GetCustomer",
                         data: "{ 'ItemName':'" + request.term + "', 'ComID':'" + hv + "'}",
                         dataType: "json",
                         type: "POST",
                         contentType: "application/json; charset=utf-8",
...
<div id="DivMain" runat="server" class="emov-page-main emov-page-main-no-top-padding" style="display:block;">   
    ...
    <div class="emov-a-rc-header emov-a-rc-header-seun">
        ...
        <div class="emov-header-page-title emov-header-page-title-table-vigo" id="emov-application-title">
            <h3 style="font-size: 25px;" class="emov-applications-title">Back Date Billing Process</h3>
                ...
                <table id="btnOpt" runat="server" style="width: 100%; display: block">
                    <tr>
                        <td>
                             ...
                             <p><asp:Label ID="lblBranchName" runat="server"></asp:Label>   Branch Name </p>
                           
                        </td>
                        <td><asp:DropDownList class="emov-a-header-input"  width="100%"   ID="drpStore" runat="server">   </asp:DropDownList></td>
                        <td>
                             <input id="txt_date" runat="server" type="date" class="emov-a-header-input" />
                        </td>
                       
                        <td>
                            <button id="btnNew" type="button" runat="server" class="emov-dash-icon-cover1" style="margin-right: 10px;" onserverclick="BtnNewOpt">New Bill<i class="fa fa-plus" aria-hidden="true"></i></button>
                        </td>
...
<div id="DivAdd" runat="server"  class="emov-page-main emov-page-main-no-top-padding" width="100%" style="display:none;">      
    ...
    <div class="emov-a-single-user-card-header">   <h2 class="h2label">Back Data Ticket  Details</h2>  </div> 
...
<asp:HiddenField ID="hdnBillingDate" runat="server" ClientIDMode="Static" Value=""  />
</div>
