<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" EnableEventValidation="false"  CodeBehind="frmCompanyUserMaster.aspx.cs" Inherits="frmCompanyUserMaster" %>
    ...
    <div style="overflow-x:scroll; text-align:center">
     ...
     <!-- Add Add Name -->      
      ...
      <%--  <asp:RequiredFieldValidator ErrorMessage="Required" ControlToValidate="FileUpload1"   runat="server" Display="Dynamic" ForeColor="Red" EnableClientScript="true" ValidationGroup="File" />    --%>
        ...
        <td><p> <asp:DropDownList class="emov-a-slot-creation-time-input emov-a-header-input-mob"  width="100%"   ID="drpCompanyName" runat="server">   </asp:DropDownList>
               <asp:RequiredFieldValidator ID="RequiredFieldValidator4" ErrorMessage="Company name is required!" Display="Dynamic" ForeColor="Red"  ControlToValidate="drpCompanyName" InitialValue="0"  ValidationGroup="AddSign" runat="server" /> </p></td>
        <td style="width:51px;"></td>
        ...
        <tr>
        <td><p>Company Name</p></td>
        <td><p><asp:Label ID="lblCompanyName" runat="server" Text="" Height="1px"></asp:Label></p></td>
        <td style="width:51px;"></td>
        <td><p><span>Group Name</span></p></td>
     ...
     <!-- Edit Add Name -->      
        ...
        <tr>
        <td><p>Company Name*</p></td>
        <td><p> <asp:DropDownList class="emov-a-slot-creation-time-input emov-a-header-input-mob"  width="100%"   ID="drpECompanyName" runat="server">   </asp:DropDownList>
               <asp:RequiredFieldValidator ID="RequiredFieldValidator7" ErrorMessage="Company name is required!" Display="Dynamic" ForeColor="Red"  ControlToValidate="drpECompanyName" InitialValue="0"  ValidationGroup="AddSign1" runat="server" /> </p></td>
        <td style="width:51px;"></td>
        <td><p><span>Group Name</span></p></td>
