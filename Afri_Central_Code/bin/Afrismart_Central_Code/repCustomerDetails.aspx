<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="repCustomerDetails.aspx.cs" Inherits="Afri_Central_Code.repCustomerDetails" %>
            ...
            <div id="div_main" runat="server" class="emov-page-main emov-page-main-no-top-padding">
                ...
                <div class="emov-a-rc-header emov-a-rc-header-seun">
                    ...
                    <div class="emov-header-page-title emov-header-page-title-table-vigo" id="emov-application-title">
                        <h3 style="font-size: 25px;" class="emov-applications-title">Customer Details Report</h3>
                        <!-- Total Count-->
                        ...
                        <div class="emov-t-actions-group" style="display: block;">
                            <table id="btnOpt" runat="server" style="width: 100%; display: block">
                                <tr>
                                    ...
                                    <td>
                                        <button id="btnSearch" type="button" runat="server" class="emov-dash-icon-cover1" style="margin-right: 10px;" onmousemove="getDtRange()" onserverclick="BtnSearchOpt"><i class="fa fa-search" aria-hidden="true"></i>SEARCH </button>
                                    </td>
                                    <td>
                                        <button id="btnPrint" type="button" runat="server" class="emov-dash-icon-cover1" style="margin-right: 10px;" onserverclick="BtnPrinter"><i class="fa fa-print" aria-hidden="true"></i>PRINTER </button>
                                    </td>
                                    <td>
                                        <button id="btnDownload" type="button" runat="server" class="emov-dash-icon-cover1" style="margin-right: 10px;" onclick="getPDF();"><i class="fa fa-download" aria-hidden="true"></i>DOWNLOAD </button>
                                    </td>
                                    <td><i class="fa fa-file-excel-o"></i>
                                        <asp:Button ID="btnExcel" runat="server" CssClass="emov-dash-icon-cover1" Style="margin-right: 10px;" Text="Excel File" OnClientClick="ExportDivDataToExcel()" OnClick="btnExcel_Click" /></td>
                ...
                <div class="emov-a-rc-table-cover">
                    ...
                    <table>
                        <tr>
                            ...
                            <td>
                                <button id="" class="emov-dash-icon-cover1" style="margin-right: 5px;"><i class="fa fa-filter" aria-hidden="true"></i>FILTER BY :</button></td>
                            <td>
                                ...
                                <div class="canvas_div_pdf">
                                    ...
                                    <asp:Panel ID="pnlDetails" runat="server" Visible="false">
                                        ...
                                        <table style="width: 100%;" align="center">
                                            ...
                                            <tr>
                                                <td align="center" colspan="8" class="h2label">CUSTOMER DETAILS REPORT</td>
                                            </tr>
                                            <tr>
                                                <tr>

                                                    <td align="center" colspan="8" class="h2label">( FROM 
                                        ...
                                        <table class="emov-a-table-data" border="1" cellspacing="1" rules="all" style="width: 100%; overflow: scroll; clip: rect(auto, auto, auto, auto);">
                                            <tr class="emov-a-table-heading">
                                                ...
                                                <th align="center" scope="col" style="white-space: nowrap;" valign="middle">Customer Name</th>
                                                <th align="center" scope="col" style="white-space: nowrap;" valign="middle">Email</th>
                                                <th align="center" scope="col" style="white-space: nowrap;" valign="middle">Mobile</th>
                                                <th align="center" scope="col" style="white-space: nowrap;" valign="middle">Store Name</th>
                                            </tr>
                                            ...
                                            <tr class="Grid_Item_Alternaterow">
                                                ...
                                                <td align="center" valign="middle">
                                                    <%=Convert.ToString(objDs.Rows[i]["CustomerEmail"])%>
                                                </td>
                                                <td align="center" valign="middle">
                                                    <%=Convert.ToString(objDs.Rows[i]["CustomerMobile"])%>
                                                </td>
            ...
            <asp:Panel ID="pnlPrntDetails" runat="server">
                ...
                <table style="width: 100%;" align="center">
                    ...
                    <tr>
                        <tr>
                            ...
                            <td align="center" colspan="8" class="h2label">( FROM 
                                <asp:Label ID="lblRFDate" runat="server"></asp:Label>
                                &nbsp;TO&nbsp;<asp:Label ID="lblRTDate" runat="server"></asp:Label>
                                )</td>
                        </tr>
                        <!--Filter -->
                        <td align="center" colspan="8" class="h3label">
                ...
                <table class="emov-a-table-data" border="1" cellspacing="1" rules="all" style="width: 100%; overflow: scroll; clip: rect(auto, auto, auto, auto);">
                    ...
                    <tr class="Grid_Item_Alternaterow">
                        ...
                        <td align="center" valign="middle">
                            <%=Convert.ToString(objDsRep.Rows[i]["CustomerEmail"])%>
                        </td>
                        <td align="center" valign="middle">
                            <%=Convert.ToString(objDsRep.Rows[i]["CustomerMobile"])%>
                        </td>
