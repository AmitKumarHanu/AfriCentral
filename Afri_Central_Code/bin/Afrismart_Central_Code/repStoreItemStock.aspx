<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="True" CodeBehind="repStoreItemStock.aspx.cs" Inherits="repStoreItemStock" %>
...
<div class="emov-page-container emov-step-wrapper">
    ...
    <div class="emov-a-rc-table-cover">  
        ...
        <td><asp:DropDownList class="emov-a-header-input"  width="100%"   ID="drpStore" runat="server">   </asp:DropDownList>  
        <td><asp:DropDownList class="emov-a-header-input"  width="100%"   ID="drpSupplier" runat="server">   </asp:DropDownList>
