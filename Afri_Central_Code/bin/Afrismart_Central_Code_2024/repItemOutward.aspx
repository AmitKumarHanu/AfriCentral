<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="True" CodeBehind="repItemOutward.aspx.cs" Inherits="repItemOutward" %>
...
<div class="emov-page-container emov-step-wrapper">
    ...
    <div  class="emov-header-page-title emov-header-page-title-table-vigo"   id="emov-application-title">
        <h3 style="font-size:25px;" class="emov-applications-title">Item Outward Report</h3>
        <!-- Total Count-->
    ...
    <!-- table within data grid-->
        ...
        <td align="center" colspan="8" class="h2label">OUTWARD ITEM REPORT</td>       
        </tr>
        ...
        <tr>
             <!--Filter -->
        <td align="center" colspan="8" class="h3label">  <asp:Label ID="Label1" runat="server"></asp:Label>  </td>   
        </tr>
        ...
        <tr>     
             <!--changes -->
        <td align="center" colspan="8" class="h2label">OUTWARD ITEM SUMMARY REPORT</td>       
        </tr>
...
%>
        ...
        <td align="center" valign="middle"> 
        <%=Convert.ToString  (objDsRep.Rows[i]["TicketDate"]) %>
        </td>
