...
public partial class frmCompanyUserMaster : System.Web.UI.Page
{
    ...
    public void bindgrid()
    {
        ...
        try
        {
            string qry = " Select * from vw_UserDetails where Level=2  order by First_Name, Last_Name  ";
            ...
            //-------------Bind GroupMaster----------------
            string qry1 = " Select GroupID ,GroupName  from tbl_GroupMaster where Level=2  order by GroupName";
            ...
            //-------------Bind CompanyMaster------------------
            string qry2 = " Select Com_ID ,Com_Name  from tbl_CompanyMaster order by Com_Name";
            DataTable dt2 = new DataTable();
            dt2 = CommonFunctions.fetchdata(qry2);

            drpCompanyName.DataSource = dt2;
    ...
    protected void BtnSearchOpt(object sender, EventArgs e)
    {
        try
        {
            ...
            string qry = "";
            qry = "  Select * From  vw_UserDetails where ( UserName like '" + txtSearch.Value.Trim() + "%' or First_Name like '" + txtSearch.Value.Trim() + "%' or Last_Name like '" + txtSearch.Value.Trim() + "%' )  and Level=2 order by First_Name, Last_Name ";
    ...
    protected void BtnEditOpt(object sender, EventArgs e)
    {
        try
        {
            ...
            {
                string qry = "";
                qry = "  Select * From  tbl_UserMaster where UserName = '" + txtSearch.Value.Trim() + "' and Level=2   order by First_Name, Last_Name ";
                ...
                if (dt.Rows.Count > 0)
                {
                    ...
                    drpECompanyName.SelectedIndex = drpECompanyName.Items.IndexOf(drpECompanyName.Items.FindByValue(dt.Rows[0]["Com_Id"].ToString()));
    ...
    protected void btnSaveAddUser_Click(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            if (txtFirstName.Text.ToString() != string.Empty && txtLoginID.Text.ToString() != string.Empty)
            {
                ...
                cmd.Connection = cn1;
                cmd.CommandText = "SP_AF_CompanyUserMaster";
                ...
                cmd.Parameters.AddWithValue("@Com_ID", drpCompanyName.SelectedValue.Trim());
    ...
    protected void btnEUpdate_Click(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            if (txtEFirstName.Text.ToString() != string.Empty && txtELoginID.Text.ToString() != string.Empty)
            {
                ...
                cmd.Parameters.AddWithValue("@Com_ID", drpECompanyName.SelectedValue.Trim());
                cmd.Parameters.AddWithValue("@Userid", dt_login_details.Rows[0]["Userid"].ToString());
