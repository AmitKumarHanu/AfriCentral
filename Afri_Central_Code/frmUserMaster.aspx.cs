...
public partial class frmUserMaster : System.Web.UI.Page
{
    ...
    public void bindgrid()
    {
        ...
        try
        {
            string qry = " Select * from vw_UserDetails where Level=3 and Com_ID='" + dt_login_details.Rows[0]["Com_ID"].ToString() + "' order by First_Name, Last_Name  ";
            ...
            //-------------Bind GroupMaster----------------
            string qry1 = " Select GroupID ,GroupName  from tbl_GroupMaster where Level=3  order by GroupName";
            ...
            //-------------Bind Store Master------------------
            string qry2 = " Select Br_id, Br_Name From tbl_BranchMaster order by Br_Name ";
            DataTable dt2 = new DataTable();
            dt2 = CommonFunctions.fetchdata(qry2);

            drpStoreName.DataSource = dt2;
            drpStoreName.DataValueField = "Br_id";
            drpStoreName.DataTextField = "Br_Name";
            drpStoreName.DataBind();
            drpStoreName.Items.Insert(0, new ListItem("--Select Store--", "0"));

            drpEStoreName.DataSource = dt2;
            drpEStoreName.DataValueField = "Br_id";
            drpEStoreName.DataTextField = "Br_Name";
            drpEStoreName.DataBind();
            drpEStoreName.Items.Insert(0, new ListItem("--Select Store--", "0"));
        }
        catch (Exception ex)
        {
            DivMsg.Attributes.Add("class", "active");
    ...
    protected void BtnSearchOpt(object sender, EventArgs e)
    {
        try
        {
            ...
            string qry = "";
            qry = "  Select * From  vw_UserDetails where ( UserName like '" + txtSearch.Value.Trim() + "%' or First_Name like '" + txtSearch.Value.Trim() + "%' or Last_Name like '" + txtSearch.Value.Trim() + "%' )  and Level=3 and Com_ID='" + dt_login_details.Rows[0]["Com_ID"].ToString() + "'order by First_Name, Last_Name ";
    ...
    protected void BtnEditOpt(object sender, EventArgs e)
    {
        try
        {
            ...
            {
                string qry = "";
                qry = "  Select * From  tbl_UserMaster where UserName = '" + txtSearch.Value.Trim() + "' and Level=3  and Com_ID='" + dt_login_details.Rows[0]["Com_ID"].ToString() + "' order by First_Name, Last_Name ";
                ...
                if (dt.Rows.Count > 0)
                {
                    ...
                    drpEStoreName.SelectedIndex = drpEStoreName.Items.IndexOf(drpEStoreName.Items.FindByValue(dt.Rows[0]["Br_Id"].ToString()));
    ...
    protected void grdUserDetails_SelectedIndexChanged(object sender, EventArgs e)
    {
        try
        {
            ...
            if (dt.Rows.Count > 0)
            {
                ...
                lblPassword.Text = CommonFunctions.DecryptString(dt.Rows[0]["Password"].ToString()) ;
                ...
                lblStoreName.Text = dt.Rows[0]["Br_Name"].ToString();
    ...
    //--------------Back Find User Grid display div --------------
    ...
    protected void btnSaveAddUser_Click(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            if (txtFirstName.Text.ToString() != string.Empty && txtLoginID.Text.ToString() != string.Empty)
            {
                ...
                cmd.Connection = cn1;
                cmd.CommandText = "SP_AF_StoreUserMaster";
                ...
                cmd.Parameters.AddWithValue("@Br_ID", drpStoreName.SelectedValue.Trim());
                ...
                if (R != String.Empty)
                {
                    ...
                    if (R != String.Empty)
                    {
                        ...
                        Response.Redirect("frmUserMaster.aspx");
                    }
                    else
                    {
                        pnlMain.Attributes.Add("style", "display:block;");
    ...
    protected void btnEUpdate_Click(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            if (txtEFirstName.Text.ToString() != string.Empty && txtELoginID.Text.ToString() != string.Empty)
            {
                ...
                cmd.Parameters.AddWithValue("@Com_ID", dt_login_details.Rows[0]["Com_ID"].ToString());
                cmd.Parameters.AddWithValue("@Br_ID", drpEStoreName.SelectedValue.Trim());
                cmd.Parameters.AddWithValue("@Userid", dt_login_details.Rows[0]["Userid"].ToString());
