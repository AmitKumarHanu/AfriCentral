<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" EnableEventValidation="false" CodeBehind="frmItemReturnVerify.aspx.cs" Inherits="frmItemReturnVerify" %>
...
<ContentTemplate>  
    ...
    <div  class="emov-header-page-title emov-header-page-title-table-vigo"   id="emov-application-title">
        <h3 style="font-size:25px;" class="emov-applications-title">Item Return Details</h3>
        <!-- Total Count-->
...
<asp:Panel ID="pnlOrderDetails" runat="server"  class="emov-page-main emov-page-main-no-top-padding" width="100%"    style="display:block">    
  ...
  <div class="emov-a-single-user-card-header">   <h2 class="h2label">Item Return Details </h2>  </div> 
    ...
    <div style="overflow-x:scroll; text-align:center">
       <%-- ----%>
        ...
        <Columns>
         ...
         <asp:TemplateField HeaderStyle-CssClass="emov-a-table-heading" HeaderText="Ticket No" Visible="false">
        <ItemTemplate>
        ...
        <asp:TemplateField HeaderStyle-CssClass="emov-a-table-heading" HeaderText="ItemRegNo"  >
        <ItemTemplate>
        <asp:Label ID="lblBranchName" runat="server" Text='<%# Bind("BranchName") %>'></asp:Label>
        </ItemTemplate>
        <ItemStyle HorizontalAlign="Left" />
        ...
        <asp:TemplateField HeaderStyle-CssClass="emov-a-table-heading" HeaderText="BarcodeNo" >
        <ItemTemplate>
        ...
        <asp:Button ID="btnVerifyReturn" runat="server" Text="RETRUN VERIFY" Visible="true" class="login-btn"   style="float: right;"    OnClick="btnVerifyReturn_Click"/>   
...
<Triggers>
<asp:AsyncPostBackTrigger ControlID="btnVerifyReturn" EventName="Click" /> 
</Triggers>
</asp:UpdatePanel>
