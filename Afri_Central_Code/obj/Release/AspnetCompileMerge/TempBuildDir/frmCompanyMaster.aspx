<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" EnableEventValidation="false"  CodeBehind="frmCompanyMaster.aspx.cs" Inherits="Afri_Central_Code.frmCompanyMaster" %>
...
<div id="div_main" runat="server" class="emov-page-main emov-page-main-no-top-padding">
    ...
    <div class="emov-a-rc-header emov-a-rc-header-seun">
        ...
        <div class="emov-header-page-title emov-header-page-title-table-vigo" id="emov-application-title">
            <h3 style="font-size: 25px;" class="emov-applications-title">Company Details</h3>
            <!-- Total Count-->
        ...
        <div class="emov-a-header-action-group">
            <div class="emov-t-actions-group" style="display: block;">
                ...
                <table id="btnOpt" runat="server" style="width: 100%; display: block">
                    <tr>
                        <td>
                            <input type="text" id="txtSearch" runat="server" class="emov-a-header-input" placeholder="Company Name / VAT Reg No. " /></td>
                        <td></td>
                        <td>
        ...
        <tr>
            <td>
                <div style="overflow-x: scroll; text-align: center">
                    ...
                    <asp:GridView ID="grdCompanyDetails" runat="server" AllowPaging="true" AllowSorting="true" AutoGenerateColumns="False" Border="0px" BorderColor="White" CssClass="emov-a-table-data"
                        OnPageIndexChanging="grdCompanyDetails_PageIndexChanging" PageSize="10" ShowHeaderWhenEmpty="true" Width="100%"
                        OnRowCommand="grdCompanyDetails_RowCommand"
                        OnRowDataBound="grdCompanyDetails_RowDataBound"
                        OnSelectedIndexChanged="grdCompanyDetails_SelectedIndexChanged">
                        <AlternatingRowStyle />
                        <Columns>
                            <asp:TemplateField HeaderStyle-CssClass="emov-a-table-heading" HeaderText="ID">
                                <ItemTemplate>
                                    <asp:Label ID="lblCompID" runat="server" Text='<%# Bind("Com_ID") %>'></asp:Label>
                                </ItemTemplate>
                                <ItemStyle HorizontalAlign="Center" />
                            </asp:TemplateField>
                            <asp:TemplateField HeaderStyle-CssClass="emov-a-table-heading" HeaderText="Company Name">
                                <ItemTemplate>
                                    <asp:Label ID="lblCompName" runat="server" Text='<%# Bind("Com_Name") %>'></asp:Label>
                                </ItemTemplate>
                                <ItemStyle HorizontalAlign="Center" />
                            </asp:TemplateField>
                            <asp:TemplateField HeaderStyle-CssClass="emov-a-table-heading" HeaderText="Phone No.">
                                <ItemTemplate>
                                    <asp:Label ID="lblCompPhoneNo" runat="server" Text='<%# Bind("Com_PhoneNo") %>'></asp:Label>
                                </ItemTemplate>
                                <ItemStyle HorizontalAlign="Center" />
                            </asp:TemplateField>
                            <asp:TemplateField HeaderStyle-CssClass="emov-a-table-heading" HeaderText="Country">
                                <ItemTemplate>
                                    <asp:Label ID="lblCompCountry" runat="server" Text='<%# Bind("CountryName") %>'></asp:Label>
                                </ItemTemplate>
                            ...
                            <asp:TemplateField HeaderStyle-CssClass="emov-a-table-heading" HeaderText="VAT Reg. No.">
                                <ItemTemplate>
                                    <asp:Label ID="lblCompVATRegNo" runat="server" Text='<%# Bind("Com_VATRegNo") %>'></asp:Label>
                                </ItemTemplate>
                                <ItemStyle HorizontalAlign="Center" />
                            </asp:TemplateField>                                                       
    ...
    <div class="emov-a-profile-full-info" style="background: white">
        ...
        <div class="emov-a-single-user-card-cover">
            ...
            <div class="emov-a-single-user-card-header">
                <h2 class="h2label">Add Company  Details</h2>
            </div>
            ...
            <div class="emov-a-single-user-card-inner-info">
                ...
                <table class="emov-a-table-data1">
                    ...
                    <%--CompanyID --%>
                    <tr>
                        <td style="width: 20%;">   <p>Company ID * :</p>   </td>
                        <td style="width: 20%;">
                            <p>
                                <asp:TextBox runat="server" class="emov-a-slot-creation-time-input emov-a-header-input-mob" AutoPostBack="false" type="text" ID="txtCompanyID" />
                                <asp:RequiredFieldValidator ID="RequiredFieldValidator11" ErrorMessage="Company ID is required!" Display="Dynamic" ForeColor="Red" ControlToValidate="txtCompanyID" ValidationGroup="AddSign" runat="server" />
                            </p>
                        </td>
                    ...
                    <tr>
                        ...
                        <td colspan="4">
                                <p>
                                <asp:TextBox runat="server" class="emov-a-slot-creation-time-input" Width="100%"  AutoPostBack="false" type="text" ID="txtCompanyName" />
                                <asp:RequiredFieldValidator ID="RequiredFieldValidator3" ErrorMessage="Company Name is required!" Display="Dynamic" ForeColor="Red" ControlToValidate="txtCompanyName" ValidationGroup="AddSign" runat="server" />
                            </p>
                        </td>
                    ...
                    <tr>
                        ...
                        <td colspan="3" style="height: 8px;">
                                ...
                                <asp:Button ID="btnSaveCompany" runat="server" class="login-btn"   style="float: right;"    OnClick="btnSaveCompany_Click" Text="SAVE" ValidationGroup="AddSign" Visible="true" />
            
                                <asp:Button ID="btnBackSaveCompany" runat="server" class="login-btn"   style="float: right;"  OnClick="btnBackSaveCompany_Click" Text="BACK" Visible="true" />
...
<div id="divView" runat="server" class="emov-page-main emov-page-main-no-top-padding" width="100%">
    ...
    <div class="emov-a-profile-full-info" style="background: white">
        <div class="emov-a-single-user-card-cover">
            <%--  View Company Master ---%>
            <div class="emov-a-single-user-card-header">
                <h2 class="h2label">View Company  Details</h2>
            </div>
            <div class="emov-a-single-user-card-inner-info">
                ...
                <table class="emov-a-table-data1">
                   ...
                   <%-- [Com_State],[Com_VATRegNo],[Com_VAT],[Com_Discount],[Com_Remark],[isActive]--%>
                    ...
                    <tr>
                        <td style="width: 20%;"> <p>Company ID * :</p>  </td>
                        <td style="width: 20%;">
                            <p>  <asp:Label ID="lblCompanyID" runat="server" Text="" Height="1px"></asp:Label>  </p>
                        </td>
                        <td style="width: 20%"></td>
                        <td style="width: 20%;"></td>
                        <td style="width: 20%;"></td>
                    ...
                    <tr>
                        ...
                        <td>
                            <p>
                                <asp:Label ID="lblCompanyName" runat="server" Text="" Height="1px"></asp:Label>
                            </p>
                        </td>
                        <td style="width: 20%"></td>                                          
                    ...
                    <tr>
                        <td>
                          ...
                          <td colspan="4">
                            <p>
                                <asp:Label ID="lblCompanyAddress" runat="server" Text="" Height="1px"></asp:Label>
                            </p>
                        </td>
                    ...
                    <tr>
                        ...
                        <td>
                            <div  style="margin-top: 0px;">
                                <asp:Button ID="BtnBackFind" runat="server"  style="float: right;"  Text="BACK" Visible="true" class="login-btn" OnClick="BtnBackFind_Click" />
                            </div>
                        </td>
                    </tr>
...
<div id="DivEdit" runat="server" class="emov-page-main emov-page-main-no-top-padding" width="100%">
    ...
    <div class="emov-a-profile-full-info" style="background: white">
        ...
        <%--  Edit Company Details Master ---%>
        <div class="emov-a-single-user-card-cover">
            <div class="emov-a-single-user-card-header">
                <h2  class="h2label">Edit Company Details </h2>
            </div>
            <div class="emov-a-single-user-card-inner-info">
                ...
                <table class="emov-a-table-data1">
                    ...
                    <tr>
                        ...
                        <td style="width: 20%;">
                            <p>
                                <asp:TextBox runat="server" class="emov-a-slot-creation-time-input emov-a-header-input-mob" AutoPostBack="false" type="text" ID="txtECompanyID" />
                                <asp:RequiredFieldValidator ID="RequiredFieldValidator5" ErrorMessage="Company ID is required!" Display="Dynamic" ForeColor="Red" ControlToValidate="txtECompanyID" ValidationGroup="AddSign1" runat="server" />
                            </p>
                        </td>
                        <td style="width: 20%"></td>
                        <td style="width: 20%;"></td>
                    ...
                    <tr>
                        ...
                        <td colspan="4">
                                ...
                                <asp:RequiredFieldValidator ID="RequiredFieldValidator14" ErrorMessage="Company Name is required!" Display="Dynamic" ForeColor="Red" ControlToValidate="txtECompanyName" ValidationGroup="AddSign1" runat="server" />
                            </p>
                        </td>
                    ...
                    <tr>
                        ...
                        <td colspan="4">
                            <p>
                                ...
                                <asp:RequiredFieldValidator ID="RequiredFieldValidator15" ErrorMessage="Address ID is required!" Display="Dynamic" ForeColor="Red" ControlToValidate="txtECompanyAddress" ValidationGroup="AddSign1" runat="server" />
                            </p>
                        </td>
                    ...
                    <tr>
                        ...
                        <td>
                            <p>
                                ...
                                <asp:RegularExpressionValidator ID="RegularExpressionValidator1" runat="server" ControlToValidate="txtEPhoneNo" ErrorMessage="Enter phone number only 11 digit" ValidationGroup="AddSign1" ForeColor="Red" ValidationExpression="[0-9]{11}" />
                            </p>
                        </td>
