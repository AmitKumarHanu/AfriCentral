<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="True" EnableEventValidation="false" CodeBehind="frmItemPriceCorrection.aspx.cs" Inherits="frmItemPriceCorrection" %>
        ...
        $(function () {
            ...
            $('#<%=txtBarCodeNo.ClientID%>').autocomplete({
                source: function (request, response) {
                    $.ajax({
                        url: "frmItemPriceCorrection.aspx/GetBarcode",
     ...
     <script language="javascript" type="text/javascript">
         $(function () {
             ...
             $('#<%=txtItemName.ClientID%>').autocomplete({
                 source: function (request, response) {
                     $.ajax({
                         url: "frmItemPriceCorrection.aspx/GetitemName",
...
<div id="DivMain" runat="server" class="emov-page-main emov-page-main-no-top-padding" style="display:block;">   
    ...
    <div class="emov-a-rc-header emov-a-rc-header-seun">
        ...
        <div class="emov-header-page-title emov-header-page-title-table-vigo" id="emov-application-title">
            <h3 style="font-size: 25px;" class="emov-applications-title">Item Price Corrections</h3>
