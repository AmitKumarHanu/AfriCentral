<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" EnableEventValidation="false" CodeBehind="frmItemQuantityAdjustment.aspx.cs" Inherits="Afri_Central_Code.frmItemQuantityAdjustment" %>
        ...
        $(function () {
            ...
            $('#<%=txtBarCodeNo.ClientID%>').autocomplete({
                source: function (request, response) {
                    $.ajax({
                        url: "frmItemQuantityAdjustment.aspx/GetBarcode",
                ...
                focus: function (event, ui) {
                    ...
                    $('#<%=txtQuanity.ClientID%>').val(ui.item.Quantity);
                ...
                return $("<li class='ui-autocomplete-row'></li>")
                    .append("<a>BarCodeNo:" + item.BarCodeNo + "<br>Name: " + item.Name + "<br>Specification: " + item.Specification + "</a>")
                    .appendTo(ul);
            };
        });
    </script>
     ...
     <script language="javascript" type="text/javascript">
         $(function () {
             ...
             $('#<%=txtItemName.ClientID%>').autocomplete({
                 source: function (request, response) {
                     $.ajax({
                         url: "frmItemQuantityAdjustment.aspx/GetitemName",
...
<div id="DivMain" runat="server" class="emov-page-main emov-page-main-no-top-padding" style="display:block;">   
    ...
    <div class="emov-a-rc-header emov-a-rc-header-seun">
        ...
        <div class="emov-header-page-title emov-header-page-title-table-vigo" id="emov-application-title">
            <h3 style="font-size: 25px;" class="emov-applications-title">Store Item Quantity Adjustment</h3>
        ...
        <div class="emov-a-header-action-group">
            <div class="emov-t-actions-group" style="display:block;">
                ...
                <table id="btnOpt" runat="server" style="width: 100%; display: block">
                    <tr>
                        <td >  </td>
                        <td > <asp:DropDownList class="emov-a-slot-creation-time-input emov-a-header-input-mob"  width="100%"   ID="drpStore" runat="server"/>  </td>
                        <td>
                            <button id="btnSearch" type="button" runat="server" class="emov-dash-icon-cover1" style="margin-right: 10px;" ReadOnly="true"  onserverclick="BtnSearchOpt">Correction <i class="fa fa-pen" aria-hidden="true"></i></button>
                        </td>
                        <td>                 
                        </td>
    ...
    <div style="overflow-x:scroll; text-align:center">
       <%-- ----%>
        ...
        <ItemStyle HorizontalAlign="Center" />
             ...
             <asp:TemplateField HeaderStyle-CssClass="emov-a-table-heading" HeaderText="Item Brand">
        <ItemTemplate>
...
<div id="DivAdd" runat="server"  class="emov-page-main emov-page-main-no-top-padding" width="100%" style="display:none;">      
    ...
    <div class="emov-a-single-user-card-header">   <h2 class="h2label">Store Item Quantity Adjustment </h2>  </div> 
     <div class="emov-a-single-user-card-header">   <h3 class="h2label"> <asp:Label ID="lblStoreName" runat="server" Text="Label"></asp:Label>  </h3>  </div>   
    <div class="emov-a-single-user-card-cover">
            <!--changes -->    
             ...
             <div class="emov-a-profile-full-info" style="background: white">
                ...
                <tr>  
                <td style="width: 15%;"><p><span>Quantity :</span></p>     </td>
                <td>                    
                <p>
                <asp:TextBox runat="server" class="emov-a-slot-creation-time-input emov-a-header-input-mob" AutoPostBack="false"   Width="100%"  type="text" ID="txtQuanity" />
                </p>
                </td>
                ...
                <table class="emov-a-table-data1">  
               <tr>
               <td colspan="3"><p> <asp:TextBox runat="server" class="emov-a-slot-creation-time-input emov-a-header-input-mob" BorderColor="White" AutoPostBack="false" ForeColor="White"   Width="100%"  type="text" ID="txtTicketNo" />  </p></td>                    
                <td colspan="2" > <button id="btnCorrection" type="button" runat="server" class="login-btn click"  style="float: right;"  ValidationGroup="AddSign"  onserverclick="btnCorrectionOpt"> Save Adjustment </button></td>
                 </tr>      
                </table>    
