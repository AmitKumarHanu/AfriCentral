<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="True" EnableEventValidation="false"  CodeBehind="frmUserMaster.aspx.cs" Inherits="frmUserMaster" %>
    ...
    <div style="overflow-x:scroll; text-align:center">
     ...
     <!-- Add Add Name -->      
      ...
      <%--  <asp:RequiredFieldValidator ErrorMessage="Required" ControlToValidate="FileUpload1"   runat="server" Display="Dynamic" ForeColor="Red" EnableClientScript="true" ValidationGroup="File" />    --%>
        ...
        <td><p> <asp:DropDownList class="emov-a-slot-creation-time-input emov-a-header-input-mob"  width="100%"   ID="drpStoreName" runat="server">   </asp:DropDownList>
               <asp:RequiredFieldValidator ID="RequiredFieldValidator4" ErrorMessage="Store name is required!" Display="Dynamic" ForeColor="Red"  ControlToValidate="drpStoreName" InitialValue="0"  ValidationGroup="AddSign" runat="server" /> </p></td>
        <td style="width:51px;"></td>
        ...
        <tr>
        <td><p>Store Name</p></td>
        <td><p><asp:Label ID="lblStoreName" runat="server" Text="" Height="1px"></asp:Label></p></td>
        <td style="width:51px;"></td>
        <td><p><span>Group Name</span></p></td>
     ...
     <!-- Edit Add Name -->      
        ...
        <tr>
        <td><p>Passowrd:</p></td>
        <td ><p><asp:TextBox runat="server" class="emov-a-slot-creation-time-input emov-a-header-input-mob"  AutoPostBack="false"  type="password"   ID="txtEPassword" readonly="false" />
        ...
        <tr>
        <td><p>Store Name*</p></td>
        <td><p> <asp:DropDownList class="emov-a-slot-creation-time-input emov-a-header-input-mob"  width="100%"   ID="drpEStoreName" runat="server">   </asp:DropDownList>
               <asp:RequiredFieldValidator ID="RequiredFieldValidator7" ErrorMessage="Store name is required!" Display="Dynamic" ForeColor="Red"  ControlToValidate="drpEStoreName" InitialValue="0"  ValidationGroup="AddSign1" runat="server" /> </p></td>
        <td style="width:51px;"></td>
