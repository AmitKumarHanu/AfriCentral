<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="repClientStoreSalesReport.aspx.cs" Inherits="Afri_Central_Code.repClientStoreSalesReport" %>
...
<div class="emov-page-container emov-step-wrapper">
    ...
    <div  class="emov-header-page-title emov-header-page-title-table-vigo"   id="emov-application-title">
        <h3 style="font-size:25px;" class="emov-applications-title">Client Store Sales Report</h3>
        <!-- Total Count-->
