<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="repItemInward.aspx.cs" Inherits="repItemInward" %>
...
<div class="emov-page-container emov-step-wrapper">
    ...
    <!-- table within data grid-->
        ...
        <th align="center" scope="col" style="white-space: nowrap;" valign="middle">Invoice No.</th>
         <th align="center" scope="col" style="white-space: nowrap;" valign="middle">PurcahseDate</th> 
        <th align="center" scope="col" style="white-space: nowrap;" valign="middle">SupplierName</th> 
        ...
        <th align="center" scope="col" style="white-space: nowrap;" valign="middle">CostPrice (Per Unit)</th>  
        <th align="center" scope="col" style="white-space: nowrap;" valign="middle">SalesPrice (Per Unit)</th>  
        <th align="center" scope="col" style="white-space: nowrap;" valign="middle">Created By</th> 
        <th align="center" scope="col" style="white-space: nowrap;" valign="middle">Created ON</th> 
        </tr>
        ...
        <td align="center" valign="middle">
        <%=Convert.ToString(objDs.Rows[i]["InvoiceNo"])%>
        </td>

        <td align="center" valign="middle">
        <%=Convert.ToString(objDs.Rows[i]["CreateOn"])%>
        </td>
            
        <td align="center" valign="middle">
        <%=Convert.ToString(objDs.Rows[i]["SupplierName"])%>
        </td>
        ...
        <%      
                    T = T + Convert.ToDecimal(objDs.Rows[i]["Quantity"]);
                }
            }%>

        <tr class="Grid_Item_Alternaterow">
        <td colspan="8" align="right" valign="right" style="font-weight:bold" >Total &nbsp;  &nbsp;</td>
       ...
       <!-- Report Summary Display-->
        ...
        <tr class="emov-a-table-heading">
        <th align="center" scope="col" style="white-space: nowrap;" valign="middle">Sl.No.</th>   
        <th align="center" scope="col" style="white-space: nowrap;" valign="middle">InvoiceNo</th>   
        <th align="center" scope="col" style="white-space: nowrap;" valign="middle">PurcahseDate</th> 
        <th align="center" scope="col" style="white-space: nowrap;" valign="middle">SupplierName</th> 
   ...
   <th align="center" scope="col" style="white-space: nowrap;" valign="middle">Created ON</th> 
        ...
        <td align="center" valign="middle"> 
        <%=Convert.ToString(objSDs.Rows[i]["InvoiceNo"])%> 
        </td>
       
        <td align="center" valign="middle">
        <%=Convert.ToString(objSDs.Rows[i]["CreateOn"])%>
        </td>

        <td align="center" valign="middle"> 
        <%=Convert.ToString(objSDs.Rows[i]["SupplierName"])%> 
        </td>

        <td align="center" valign="middle"> 
        <%=Convert.ToString(objSDs.Rows[i]["ItemName"])%> 
        </td>
        
        <td align="center" valign="middle">
        <%=Convert.ToString(objSDs.Rows[i]["ItemSpecification"])%>  
        </td> 
        <td align="center" valign="middle">
    ...
    <!-- table within data grid-->
     ...
     <!-- Printing Div --> 
        ...
        <td align="center" colspan="8" class="h2label">( FROM  <asp:Label ID="lblFDateR" runat="server"></asp:Label>   &nbsp;TO&nbsp;<asp:Label ID="lblTDateR" runat="server"></asp:Label>   )</td>   
         ...
         <tr>
             <!--Filter -->
        <td align="center" colspan="8" class="h3label">  <asp:Label ID="lblRDilter" runat="server"></asp:Label>  </td>   
        </tr>
...
%>
        ...
        <td align="center" valign="middle">
        <%=Convert.ToString(objDsRep.Rows[i]["InvoiceNo"])%>
        </td>
        
        <td align="center" valign="middle">
        <%=Convert.ToString(objDsRep.Rows[i]["CreateOn"])%>
        </td>
            
        <td align="center" valign="middle">
        <%=Convert.ToString(objDsRep.Rows[i]["SupplierName"])%>
        </td>
        ...
        <%      
                    T = T + Convert.ToDecimal(objDsRep.Rows[i]["Quantity"]);
                }
            }%>

        <tr class="Grid_Item_Alternaterow">
        <td colspan="7" align="right" valign="right" style="font-weight:bold" >Total &nbsp;  &nbsp;</td>
        <td  align="center" align="right" valign="right" style="font-weight:bold"> 
            <%=Convert.ToDecimal(T)%>
        </td>
        ...
        <td align="center" colspan="8"class="h2label">( FROM  <asp:Label ID="lblSDateFRep" runat="server"></asp:Label>   &nbsp;TO&nbsp;<asp:Label ID="lblSDateDRep" runat="server"></asp:Label>   )</td>   
         ...
         <tr>
             <!--Filter -->
        <td align="center" colspan="8" class="h3label">  <asp:Label ID="lblRSfilter" runat="server"></asp:Label>  </td>   
        </tr>
...
=       <tr class="emov-a-table-heading">
      ...
      %>
        ...
        <td align="center" valign="middle"> 
        <%=Convert.ToString(objSDsRep.Rows[i]["InvoiceNo"])%> 
        </td>
       
        <td align="center" valign="middle">
        <%=Convert.ToString(objSDsRep.Rows[i]["CreateOn"])%>
        </td>   

        <td align="center" valign="middle"> 
        <%=Convert.ToString(objSDsRep.Rows[i]["SupplierName"])%> 
        </td>
        <td align="center" valign="middle"> 
        <%=Convert.ToString(objSDsRep.Rows[i]["ItemName"])%> 
        </td>
        
        <td align="center" valign="middle">
        <%=Convert.ToString(objSDsRep.Rows[i]["ItemSpecification"])%>  
        </td> 
        <td align="center" valign="middle">
