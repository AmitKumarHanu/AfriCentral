...
using System.Web.UI.WebControls;
  ...
  public partial class repItemOutward : System.Web.UI.Page
    {
        ...
        public void bindgrid()
        {
            ...
            try
            {
                ...
                //-------------Bind Store Master----------------
                String qry1 = " Select Br_ID, Br_Name From tbl_BranchMaster where Com_ID='"+ dt_login_details.Rows[0]["Com_ID"].ToString()  + "' order by Br_Name ";
                    ...
                    if (Case == "1")
                        {
                                ...
                                string qry = " Select TicketNo, Convert(varchar(10), TicketDate, 103) as TicketDate, Com_Name, BranchName, Brand, CategoryName, SupplierName, Quantity As Quantity   " +
                                " from vw_ItemOutward  where  istransfer = 1 and  Com_ID='" + dt_login_details.Rows[0]["Com_ID"].ToString() + "'   and CreateOn  between '" + dateF.ToString() + "  00:00:00.000' and '" + dateT.ToString() + " 23:59:59.000' " + condition + " " +
                                "group by TicketNo, TicketDate, Com_id, Com_Name, Br_id, BranchName, Brand, CID, CategoryName, SID, SupplierName , Quantity  " + 
                        ...
                        if (Case == "2")
                        {
                            ...
                            string qry = " Select TicketNo, Convert(varchar(10), TicketDate, 103) as TicketDate, ItemName,ItemSpecification, Brand,BarCodeNo,Quantity,Hold_Quantity,CostPrice,SalesPrice, EmployeeID,UserName,CreateON,SID,SupplierName,CID,CategoryName, Com_ID,Com_Name,Br_ID,Br_Name,TicketDate  " +
                                " from vw_ItemOutward where istransfer = 1 and  Com_ID='" + dt_login_details.Rows[0]["Com_ID"].ToString() + "'  and CreateOn  between '" + dateF.ToString() + "  00:00:00.000' and '" + dateT.ToString() + " 23:59:59.000' " + condition + " "+
